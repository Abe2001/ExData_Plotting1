...
##### FINALLY ! The data is now in the right format for the plot1 (Histogram) to be plotted ! 
png(file = "plot1.png", width = 480, height = 480);
hist(DF4$Global_active_power, xlab="Global Active Power (kilowatts)", main="Global Active Power", col="red");
dev.off();

## Visually inspect the PNG file to confirm that it (almost) matches the output from the instructor's GitHub fork
