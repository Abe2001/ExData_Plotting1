...
##### FINALLY ! The data is now in the right format for the plot 4 to be plotted ! 
## Plot4 is a comination of 4 separate plots on the same pallette

png(file = "plot4.png", width = 480, height = 480);
par(mfrow = c(2,2));

## 1st plot of the 4 (position Row1, Col1): Global Active Power
plot(DF2$DateTimeStamp, DF2$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power");

## 2nd plot of the 4 (position Row1, Col2): Voltage
plot(DF2$DateTimeStamp, DF2$Voltage, type = "l", xlab = "datetime", ylab = "Voltage");

## 3rd plot of the 4 (position Row2, Col1): Sub_metering_1/2/3
...
## 4th plot of the 4 (position Row2, Col2): Global Reactive Power
plot(DF2$DateTimeStamp, DF2$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power");
